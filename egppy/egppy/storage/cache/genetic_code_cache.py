...
remote_cache_client: CacheABC = UserDictCache(config=remote_cache_client_config)
...
compact_cache = UserDictCache(config=compact_cache_config)
...
fast_cache: CacheABC = DictCache(config=fast_cache_config)
