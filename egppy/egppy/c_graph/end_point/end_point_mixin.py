...
from egppy.c_graph.c_graph_key import DESTINATION_ROWS, EP_CLS_STR_TUPLE, ROWS, SOURCE_ROWS
from egppy.c_graph.c_graph_validation import valid_dst_rows, valid_src_rows, CGraphType
from egppy.c_graph.c_graph_key import SrcRow, DstRow, EndPointClass, EndPointHash, Row
...
class EndPointMixin(CommonObjMixin):
    ...
    def del_invalid_refs(self, gt: CGraphType = CGraphType.STANDARD) -> None:
    ...
    def move_copy(
        self, row: Row, clean: bool = False, gt: CGraphType = CGraphType.STANDARD
    ) -> EndPointABC:
