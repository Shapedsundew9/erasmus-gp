...
## Active Technologies
- Python 3.12 (as per Constitution) + Internal Erasmus GP packages (`egpcommon`, `egppy`) (003-bootstrap-mutations)
- N/A (Mutations operate on in-memory `EGCode` objects) (003-bootstrap-mutations)

## Recent Changes
- 003-bootstrap-mutations: Added Python 3.12 (as per Constitution) + Internal Erasmus GP packages (`egpcommon`, `egppy`)
